...
public static class MonkeyHelper
{
    ...
    // Tracks the number of times each monkey is accessed by name
    ...
    /// <summary>
    /// Gets a random monkey from the list and tracks access.
    /// </summary>
    ...
    /// <summary>
    /// Finds a monkey by name (case-insensitive) and tracks access.
    /// </summary>
    ...
    {
        accessCounts.TryGetValue(name, out var count);
        return count;
    }
